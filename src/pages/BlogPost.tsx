      ...
      <main className="min-h-screen bg-background">
        ...
        <section>
          <div className="container max-w-4xl py-20">
            ...
            {/* RELATED RESOURCES */}
            <div className="mt-24 rounded-3xl border border-border bg-card p-10">
              ...
              <div className="mt-8 grid gap-6 md:grid-cols-2">
                ...
                <a
                  href="/features/downloads-cleanup"
                  className="rounded-2xl border border-border p-6 transition-colors hover:bg-secondary"
                >
                  <h3 className="text-xl font-semibold">
                    Automatic Downloads Cleanup
                  </h3>

                  <p className="mt-3 text-muted-foreground">
                    Automatically clean and structure messy downloads folders.
                  </p>
                </a>
                ...
                >
                  ...
                  <p className="mt-3 text-muted-foreground">
                    Compare Foldora with Hazel for file automation workflows.
                  </p>
                </a>
                ...
                >
                  <h3 className="text-xl font-semibold">
                    Downloads Folder Guides
                  </h3>

                  <p className="mt-3 text-muted-foreground">
                    Explore AI-powered downloads folder organization workflows.
                  </p>
                </a>
            ...
            <div className="mt-24">
              ...
              <div className="mt-8 grid gap-6 md:grid-cols-2">
                ...
                >
                  <h4 className="text-xl font-semibold">
                    How To Organize PDFs Automatically
                  </h4>

                  <p className="mt-3 text-muted-foreground">
                    Automatically structure and organize large PDF collections.
                  </p>
                </a>
                ...
                >
                  <h4 className="text-xl font-semibold">
                    Best Offline AI File Organizer
                  </h4>

                  <p className="mt-3 text-muted-foreground">
                    Discover privacy-focused local AI organization workflows.
                  </p>
                </a>
